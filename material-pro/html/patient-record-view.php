        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                        ...
                        <!--End Logo icon -->
                        <!-- Logo text --> <span class="navbar-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"><div class="user-img"> <span class="round">H</span> <span class="profile-status away pull-right"></span> </div>
                                    <h4 class="card-title m-t-10">Hanna Gover</h4>
                                    <h6 class="card-subtitle">Management Head</h6>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="valadminview.php" method="POST">
                                    <div class="form-group">
                                        <label class="col-md-12">Patient Unique ID</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Patient ID" class="form-control form-control-line" name="pat">
                                        </div>
                                        <div class="btnlog">
                                        <button class="btn btn-success btnl" type="submit" value="Login">Search</button>      
                                        </div>
                                    </div>
                                    </div>
                                </form>
