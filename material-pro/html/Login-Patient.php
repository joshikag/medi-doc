    ...
    <!-- <div id="main-wrapper"> -->
        <header class="topbar">
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <span><em class="heading">Patient</em></span>
            </nav>
        </header>
        <section class="Username" id="username">
            <div class="login">
                <form class="form-horizontal form-material" action="validpatient.php" method="POST">
                    <div class="form-group">
                        <label class="login2">Login</label>
                        <div>
                            <input type="text" placeholder="Enter username" class="form-control form-control-line" id="uname" name="patuser">
                            </div>
                            <br>
                            <div>
                            <input type="password" placeholder="Enter password" class="form-control form-control-line" id="pass" name="patpass">
                            </div>
                        </div>
                    </div>
                    <div class="btnlog">
                    <button class="btn btn-success btnl" type="submit">submit</button>
                    </div>
                </form>
            </div>
        </section>
            ...
            <div class="login">
                <form class="form-horizontal form-material">
                    <div class="form-group">
                        ...
                        <div>
                            <input type="text" placeholder="Enter password" class="form-control form-control-line" id="pass">
                        </div>
                    </div>
                    <div class="btnlog">
                    <button class="btn btn-success btnl" type="button" onclick="checkpasspatient()">Log-in</button>
                    </div>
                </form>
            </div>
        </section> -->
